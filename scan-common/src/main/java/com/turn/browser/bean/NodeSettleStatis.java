...
public class NodeSettleStatis {
    ...
    /**
     * Statistical block height
     */
    private Long blockNum = new Long("0");

    /**
     * Create a bounded priority queue to store the node's block production statistics for 9 settlement cycles (the last 8 settlement cycles (not necessarily consecutive) + the current settlement cycle)
     */
     ...
     *
     * @param json json字符串
     * @return com.turn.browser.bean.NodeSettleStatis
     * @date 2021/6/1
     */
