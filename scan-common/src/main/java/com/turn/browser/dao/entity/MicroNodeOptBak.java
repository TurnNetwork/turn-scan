...
public class MicroNodeOptBak {
     ...
     * This enum corresponds to the database table micro_node_opt_bak
     *
     * @mbg.generated
    ...
    public enum Column {
         ...
         * This field corresponds to the database table micro_node_opt_bak
         *
         * @mbg.generated
         * @project https://github.com/itfsw/mybatis-generator-plugin
         */
