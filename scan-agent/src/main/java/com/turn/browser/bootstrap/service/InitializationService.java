...
import com.turn.browser.v0152.analyzer.GameCache;
...
public class InitializationService {
    ...
    public InitializationResult init(String traceId) throws BlockNumberException {
        ...
        if (networkStat == null) {
            ...
            // 初始化内置节点
            List<com.turn.browser.dao.entity.Node> nodeList = initInnerStake();
            // 初始化节点缓存
     ...
     * @throws Exception
     */
    private List<com.turn.browser.dao.entity.Node> initInnerStake() throws BlockNumberException {
        log.info("初始化内置节点");
        ...
        // 入库
        List<com.turn.browser.dao.entity.Node> returnData = new ArrayList<>(nodes);
        if (!nodes.isEmpty()) {
