...
public class ReceiptTest {
    ...
    public void test(){
        ...
        List<com.bubble.protocol.core.methods.response.Log> logs = new ArrayList<>();
        com.bubble.protocol.core.methods.response.Log log = new com.bubble.protocol.core.methods.response.Log();
