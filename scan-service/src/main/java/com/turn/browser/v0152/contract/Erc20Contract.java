...
public class Erc20Contract extends Contract implements ErcContract {
    ...
    protected Erc20Contract(String contractAddress,
                            Web3j web3j,
    ...
    public static RemoteCall<Erc20Contract> deploy(Web3j web3j,
                                                   Credentials credentials,
                                                   GasProvider contractGasProvider,
                                                   BigInteger _supply,
                                                   String _symbol,
        ...
        return deployRemoteCall(Erc20Contract.class,
                                web3j,
                                credentials,
                                contractGasProvider,
                                BINARY,
    ...
    public Observable<ApprovalEventResponse> approvalEventObservable(BubbleFilter filter) {
        return web3j.bubbleLogObservable(filter).map(log -> {
    ...
    public Observable<LogRegisterEventResponse> logRegisterEventObservable(BubbleFilter filter) {
        return web3j.bubbleLogObservable(filter).map(log -> {
    ...
    public Observable<LogRegisterEventResponse> logRegisterEventObservable(DefaultBlockParameter startBlock,
                                                                           DefaultBlockParameter endBlock) {
        BubbleFilter filter = new BubbleFilter(startBlock, endBlock, getContractAddress());
    ...
    public Observable<LogWithdrawalEventResponse> logWithdrawalEventObservable(BubbleFilter filter) {
        return web3j.bubbleLogObservable(filter).map(log -> {
    ...
    public Observable<LogWithdrawalEventResponse> logWithdrawalEventObservable(DefaultBlockParameter startBlock,
                                                                               DefaultBlockParameter endBlock) {
        BubbleFilter filter = new BubbleFilter(startBlock, endBlock, getContractAddress());
    ...
    public Observable<ErcTxEvent> transferEventObservable(BubbleFilter filter) {
        return web3j.bubbleLogObservable(filter).map(log -> {
    ...
    public Observable<ErcTxEvent> transferEventObservable(DefaultBlockParameter startBlock,
                                                          DefaultBlockParameter endBlock) {
        BubbleFilter filter = new BubbleFilter(startBlock, endBlock, getContractAddress());
    ...
    public static Erc20Contract load(String contractAddress,
                                     Web3j web3j,
                                     Credentials credentials,
                                     GasProvider contractGasProvider) {
