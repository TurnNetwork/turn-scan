...
public class Erc1155Contract extends Contract implements ErcContract {
    ...
    public RemoteCall<Boolean> supportsInterface(byte[] interfaceID) {
        final Function function = new Function(FUNC_SUPPORTSINTERFACE,
                Arrays.<Type>asList(new com.bubble.abi.solidity.datatypes.generated.Bytes4(interfaceID)),
    ...
    public RemoteCall<TransactionReceipt> safeBatchTransferFrom(String _from, String _to, List<BigInteger> _ids, List<BigInteger> _values, byte[] _data) {
        final Function function = new Function(
                ...
                Arrays.<Type>asList(new Address(_from),
                        ...
                        new DynamicArray<>(
                                Uint256.class,
                                com.bubble.abi.solidity.Utils.typeMap(_ids, Uint256.class)),
                        new DynamicArray<>(
                                Uint256.class,
                                com.bubble.abi.solidity.Utils.typeMap(_values, Uint256.class)),
    ...
    public RemoteCall<List> balanceOfBatch(List<String> _owners, List<BigInteger> _ids) {
        final Function function = new Function(FUNC_BALANCEOFBATCH,
                Arrays.<Type>asList(new DynamicArray<>(
                                Address.class,
                                com.bubble.abi.solidity.Utils.typeMap(_owners, Address.class)),
                        new DynamicArray<>(
                                Uint256.class,
                                com.bubble.abi.solidity.Utils.typeMap(_ids, Uint256.class))),
    ...
    public Observable<TransferSingleEventResponse> transferSingleEventObservable(BubbleFilter filter) {
    ...
    public Observable<TransferBatchEventResponse> transferBatchEventObservable(BubbleFilter filter) {
        return web3j.bubbleLogObservable(filter).map(log -> {
    ...
    public Observable<ApprovalForAllEventResponse> approvalForAllEventObservable(BubbleFilter filter) {
        return web3j.bubbleLogObservable(filter).map(log -> {
    ...
    public Observable<URIEventResponse> uRIEventObservable(BubbleFilter filter) {
        return web3j.bubbleLogObservable(filter).map(log -> {
    ...
    public List<ErcTxEvent> getTxEvents(TransactionReceipt transactionReceipt) {
        ...
        for (EventValuesWithLog eventValues : valueList) {
            ...
            // tokenId does not exist, indicating that the event is not a standard event
        ...
        for (EventValuesWithLog eventValues : batchValueList) {
            ...
            /**
             * The number of token and value must be one to correspond one to one
             */
