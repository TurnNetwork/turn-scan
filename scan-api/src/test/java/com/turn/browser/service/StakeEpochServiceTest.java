...
import com.turn.browser.response.staking.DelegationListByAddressResp;
import com.turn.browser.response.staking.DelegationListByStakingResp;
...
public class StakeEpochServiceTest extends ApiTestMockBase {
    ...
    public void setup() {
        ...
        ReflectionTestUtils.setField(this.target, "turnClient", this.turnClient);
